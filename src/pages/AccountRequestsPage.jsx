...
import { Loader2, XCircle, CheckCircle, Clock, User, Mail, Building, MapPin, Calendar } from 'lucide-react';
...
const AccountRequestsPage = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const errorMessage = err?.message || err?.error || 'Failed to load account requests';
  ...
  const handleRejectConfirm = async () => {
    ...
    try {
      ...
      await userService.rejectUserAccount(selectedRequest._id, rejectionReason);
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Review and approve user account registration requests</p>
        </div>
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-8 text-center">
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      ...
                      <p className="text-sm font-medium">No pending account requests</p>
                      <p className="text-xs text-gray-400 mt-1">All registration requests have been processed</p>
                    </div>
                  </td>
                </tr>
              ) : (
