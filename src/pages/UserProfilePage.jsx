...
const UserProfilePage = () => {
  ...
  const { data: profileData, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      // userService.getCurrentUserProfile() returns response.data from axios
      // Structure: { success: true, data: { firstName, lastName, email, ... } }
      // Extract the nested data property (same pattern as other pages)
  ...
  const updateMutation = useMutation({
    mutationFn: (data) => userService.updateCurrentUserProfile(data),
    onSuccess: () => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-medium text-gray-900 break-words">{profile.address || '—'}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="font-medium text-gray-900">{profile.globalRole || 'USER'}</p>
            </div>
            <div>
            ...
            {profile.lastLogin && (
              <div>
                ...
                <p className="font-medium">
                  {new Date(profile.lastLogin).toLocaleDateString()} {new Date(profile.lastLogin).toLocaleTimeString()}
                </p>
              </div>
            )}
            {profile.createdAt && (
